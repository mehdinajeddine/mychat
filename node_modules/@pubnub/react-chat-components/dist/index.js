...
var useMutableSource = function useMutableSource(source, getSnapshot, subscribe) {
  var lastVersion = React__default['default'].useRef();
...
var createScopeContainerForDevelopment = function createScopeContainerForDevelopment(initialValues) {
  ...
  var devSubscribe = function devSubscribe(_, callback) {
...
var useDebugState = function useDebugState(scopeContainer) {
  var store = scopeContainer[0],
      devMutableSource = scopeContainer[2],
      devSubscribe = scopeContainer[3];
  var atoms = useMutableSource(devMutableSource, React__default['default'].useCallback(function (devContainer) {
...
function useAtom(atom, scope) {
  var getAtomValue = React__default['default'].useCallback(function (store) {
  ...
  var subscribe = React__default['default'].useCallback(function (store, callback) {
...
var ChatInternal = function (props) {
    ...
    var retryOnError = React.useCallback(function (fn) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _a = props.retryOptions, maxRetries = _a.maxRetries, timeout = _a.timeout, exponentialFactor = _a.exponentialFactor;
                    _loop_1 = function (i) {
                        var _c, error_1;
    ...
    React.useEffect(function () {
        setErrorFunction({ function: function (error) { return props.onError(error); } });
    }, [props.onError]);
    React.useEffect(function () {
    ...
    var setupSubscriptions = function () {
        try {
            ...
            var newChannels = channels.filter(function (c) { return !currentSubscriptions_1.includes(c); });
            var currentGroups_1 = pubnub.getSubscribedChannelGroups();
            var newGroups = channelGroups.filter(function (c) { return !currentGroups_1.includes(c); });
    ...
    var handlePresenceEvent = function (event) {
        if (props.onPresence)
            props.onPresence(event);
    };
    var handleObjectsEvent = function (event) {
        if (event.message.type === "membership" && props.onMembership)
            props.onMembership(event);
        if (event.message.type === "channel" && props.onChannel)
            props.onChannel(event);
        if (event.message.type === "uuid" && props.onUser)
            props.onUser(event);
    };
        ...
        try {
            setMessages(function (messages) {
                ...
                if (message && event === "added") {
                    var newActions = __spreadArray(__spreadArray([], actions), [{ uuid: uuid, actionTimetoken: actionTimetoken }]);
    ...
    var handleFileEvent = function (event) {
        if (props.onFile)
            props.onFile(event);
        try {
            setMessages(function (messages) {
    ...
    var handleStatusEvent = function (event) {
        if (props.onStatus)
...
var MessageInput = function (props) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, pubnub.sendFile({ channel: channel, file: file })];
                case 1:
                    _a.sent();
                ...
                case 2:
                    ...
                    message = __assign({ type: "text", text: text }, (props.senderInfo && { sender: users.find(function (u) { return u.id === pubnub.getUUID(); }) }));
    ...
    */
    ...
    return (React__default['default'].createElement("div", { className: "pn-msg-input pn-msg-input--" + theme + " " + (props.disabled ? "pn-msg-input--disabled" : "") },
...
function useUpdateAtom(anAtom, scope) {
  ...
  var store = React__default['default'].useContext(ScopeContext)[0];
  var setAtom = React__default['default'].useCallback(function (update) {
...
var MessageList = function (props) {
    ...
    var spinnerObserver = React.useRef(new IntersectionObserver(function (e) { return e[0].isIntersecting === true && fetchMoreHistory(); }));
    var bottomObserver = React.useRef(new IntersectionObserver(function (e) { return handleBottomScroll(e[0].isIntersecting); }));
    /*
    /* Helper functions
    */
    ...
    */
    ...
    var handleBottomScroll = function (scrolledBottom) {
        try {
            if (scrolledBottom)
                setUnreadMessages(0);
    ...
    var handleHistoryFetch = utils.useAtomCallback(React.useCallback(function (get, set, response) {
        ...
        var allMessages = __spreadArray(__spreadArray([], messages), newMessages).sort(function (a, b) { return a.timetoken - b.timetoken; });
        setEmojiPickerShown(false);
    ...
    */
    ...
    var renderItem = function (envelope) {
        ...
        if (deleted)
            return;
        return (React__default['default'].createElement("div", { className: "pn-msg " + currentUserClass, key: envelope.timetoken },
    ...
    var renderReactions = function (envelope) {
        ...
        return (React__default['default'].createElement("div", { className: "pn-msg__reactions" }, Object.keys(reactions).map(function (reaction) {
            ...
            return (React__default['default'].createElement("div", { className: "pn-msg__reaction " + (userReaction ? "pn-msg__reaction--active" : ""), key: reaction, onClick: function () {
                    userReaction
    ...
    return (React__default['default'].createElement("div", { className: "pn-msg-list pn-msg-list--" + theme },
        ...
        React__default['default'].createElement("div", { className: "pn-msg-list-scroller", onScroll: props.onScroll, ref: listRef },
            ...
            props.reactionsPicker && (React__default['default'].createElement("div", { className: "pn-msg-list__emoji-picker " + (!emojiPickerShown && "pn-msg-list__emoji-picker-hidden"), ref: pickerRef }, picker)))));
};
...
var MemberList = function (props) {
    ...
    */
    ...
    return (React__default['default'].createElement("div", { className: "pn-member-list pn-member-list--" + theme },
...
var ChannelList = function (props) {
    ...
    */
    var renderChannel = function (channel) {
        ...
        return (React__default['default'].createElement("div", { key: channel.id, className: "pn-channel " + activeClass, onClick: function () { return switchChannel(channel); } },
    ...
    return (React__default['default'].createElement("div", { className: "pn-channel-list pn-channel-list--" + theme },
...
var TypingIndicator = function (props) {
    ...
    return (React__default['default'].createElement(React__default['default'].Fragment, null,
        !props.showAsMessage && !!activeUUIDs.length && (React__default['default'].createElement("div", { className: "pn-typing-indicator pn-typing-indicator--" + theme },
            getIndicationString(),
            "\u00A0")),
...
var mergeMessageArray = function (oldMessages, newMessages) {
    if (Array.isArray(oldMessages)) {
        return __spreadArray(__spreadArray([], oldMessages), newMessages).sort(function (a, b) { return a.timetoken - b.timetoken; });
    }
};
...
var usePresence = function (options) {
    ...
    var command = React.useCallback(function () { return __awaiter(void 0, void 0, void 0, function () {
        var response, e_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, pubnub.hereNow(options)];
                case 1:
                    response = _a.sent();
    ...
    var handlePresence = React.useCallback(function (event) {
...
var useUser = function (options) {
    ...
    var handleObject = function (event) {
    ...
    var command = function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    response_1 = _a.sent();
                    setUsers(function (users) { return __spreadArray(__spreadArray([], users), response_1.data); });
    ...
    var command = function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    response_1 = _a.sent();
                    setChannels(function (channels) { return __spreadArray(__spreadArray([], channels), response_1.data); });
                    setTotalCount(response_1.totalCount);
                    setPage(response_1.next);
                    return [3 /*break*/, 3];
                case 2:
...
var useChannelMembers = function (options) {
    ...
    var _f = React.useState(false), fetching = _f[0], setFetching = _f[1];
    ...
    var fetchPage = React.useCallback(function () { return __awaiter(void 0, void 0, void 0, function () {
        var response_1, e_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 2:
                    response_1 = _a.sent();
                    setMembers(function (members) { return __spreadArray(__spreadArray([], members), response_1.data.map(function (m) { return m.uuid; })); });
                    setTotalCount(response_1.totalCount);
                    setPage(response_1.next);
                    return [3 /*break*/, 5];
                case 3:
    ...
    var fetchPage = React.useCallback(function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    response_1 = _a.sent();
                    setChannels(function (channels) { return __spreadArray(__spreadArray([], channels), response_1.data.map(function (m) { return m.channel; })); });
                    setTotalCount(response_1.totalCount);
                    setPage(response_1.next);
                    return [3 /*break*/, 5];
                case 3:
